...
public class CriteriaApiTest {
	...
	public void selectPostJPQL() {
		String sql = "select p.stamp.author, p.title from Post p where p.stamp.author = 'Kevin Bowersox'";
	...
	public void joinApiTest() {
		...
		cQuery.multiselect(post.get("stamp").get("author"),postPart.get("body"));
